...
$if not set esub_labor $set esub_labor 0

* set elasticity of supply to other regions
$if not set e_nu  $set e_nu 2


* set elasticity of transformation to other regions
...
$if not set esubp_top  $set esubp_top  0
...
execute_unload "staticmodel_d2_tsubs_bmk.gdx" kd0_rpt ,tl0_d_rpt,c0_h_d_rpt  ,le0_d_rpt00, le0_d_rpt,cons0_rpt, ys0_rpt, ld0_d_rpt,cd0_h_d_rpt,c0_h_d_rpt,hhtrn0_d_rpt,ke0_d_rpt,sav0_d_rpt,id0_rpt;
...
execute_unload "staticmodel_d2_tsubs_it0.gdx" a_rpt0, SAVRATE_rpt,TAXRATE_rpt,  ra_rpt0, y_rpt0,c_rpt0,pl_rpt0,pc_rpt0,w_rpt0,phou_rpt0, le0_d_rpt0, pfx_rpt0,pk_rpt0,pn_rpt0, pm_rpt0, pa_rpt0,py_rpt0, pd_rpt0,rk_rpt0;
