...
* producer labor elasticity substition elasticity
$if not setglobal esub_l $setglobal esub_l 1.6

* consumer subs elasticity
$if not setglobal esub_c $setglobal esub_c 1

* substitution elasticity between national and local goods
$if not setglobal esub_nat $setglobal esub_nat 2
...
parameter
    ...
    esubc           consumer substitution betwwen skilled and unskilled goods
    esubnat         armington good elasticity between local and national goods
...
$prod:Y(r,s)$y_(r,s)  s:esubland(r)   nf:0 mat(nf):0 va(nf):1 lsk(va):esubl(s)
...
$prod:A(r,g)$a_(r,g)  s:0 dm:4  d(dm):esubnat
...
execute_unload "staticmodel_d2_v2_bmk_%esub_l%_%esub_c%_%esub_nat%.gdx" kd0_rpt ,tl0_d_rpt,c0_h_d_rpt  ,le0_d_rpt00, le0_d_rpt,cons0_rpt, ys0_rpt, ld0_d_rpt,cd0_h_d_rpt,c0_h_d_rpt,hhtrn0_d_rpt,ke0_d_rpt,sav0_d_rpt,id0_rpt;



*** allow more time per solve

mgemodel.iterlim=2000;
option resLim=6000;
...
execute_unload "staticmodel_d2_v2_it0_%esub_l%_%esub_c%_%esub_nat%.gdx" a_rpt0, SAVRATE_rpt,TAXRATE_rpt,  ra_rpt0, y_rpt0,c_rpt0,pl_rpt0,pc_rpt0,w_rpt0,phou_rpt0, le0_d_rpt0, pfx_rpt0,pk_rpt0,pn_rpt0, pm_rpt0, pa_rpt0,py_rpt0, pd_rpt0,rk_rpt0;
$exit;
...
$ondelim
$include le0_shock1_v2_test2_adj_d2_tag.csv
$offdelim
;
...
execute_unload "staticmodel_v2_d2_it1.gdx" SAVRATE_rpt1,TAXRATE_rpt1,  ra_rpt1, y_rpt1,c_rpt1,pl_rpt1,pc_rpt1,w_rpt1,phou_rpt1, le0_d_rpt1, pfx_rpt1,pk_rpt1,pn_rpt1, pm_rpt1, pa_rpt1,py_rpt1, pd_rpt1,rk_rpt1;
