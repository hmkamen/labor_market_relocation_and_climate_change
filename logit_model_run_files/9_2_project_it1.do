...
*************************************************initial population shock********************
	...
	forvalues i = 2/2{
		...
		merge m:1 statefip using "dta/gams_dta`t'_v2.dta"
		drop _merge
		...
		****end college loop
		...
		save "dta/projection_data_age`i'_01_wbmk_v2_`t'.dta", replace
...
**for now just use age2
	...
	***merge in full factorial, change to zero change for workers not living in the place they workers
	...
	outsheet r q h sk skill_shr using "le0_shock1_v2_test2_adj.csv", comma replace			
